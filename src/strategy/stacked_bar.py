...
class StackedGraphCreator(AbstractGraphBuilder):
    ...
    def initialize(self):
        ...
        self.db.query("INSERT INTO ClassData VALUES(null,'orange', 2, 3);")
    ...
    def create(self, statistics):
        ...
        plotly.offline.plot(fig, filename='../tmp/stacked-bar.html')